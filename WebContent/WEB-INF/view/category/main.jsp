...
<div class="bs-example" data-example-id="thumbnails-with-custom-content">
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="${ctx}/resources/img/32950_9631_126.jpg" alt="NO IMG"style="height: 300px; width: 100%; ">
          <div class="caption">
      ...
      <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
		  <img src="${ctx}/resources/img/20161128144318269879.jpg" alt="NO IMG"style="height: 300px; width: 100%; ">
          <div class="caption">
